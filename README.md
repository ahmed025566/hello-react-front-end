...
**Hello React Front End** is the front-end of a project, which is built using both back-end and front-end. The Rails back-end can be found <a href="https://github.com/ahmed025566/hello-rails-back-end.git" >here</a>.
...
```sh
  git clone https://github.com/ahmed025566/hello-react-front-end
...
Feel free to check the [issues page](https://github.com/ahmed025566/hello-react-front-end/issues/).
